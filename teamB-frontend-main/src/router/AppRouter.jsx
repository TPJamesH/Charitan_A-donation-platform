...
import RouteGuard from "../components/helper/RouteGuard";
            ...
            <div className="flex-grow p-4">
              <Routes>
                ...
                <Route
                  ...
                  element={<RouteGuard component={UserManagement} />}
                />
                <Route
                  path="/admin/admin-management"
                  element={<RouteGuard component={AdminManagement} />}
                />
                <Route
                  path="/admin/projects"
                  element={<RouteGuard component={Projects} />}
                />
                <Route
                  path="/admin/settings"
                  element={<RouteGuard component={Settings} />}
                />
                {/* Protected Routes */}
